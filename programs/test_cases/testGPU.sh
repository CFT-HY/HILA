...
transform_c(){
    echo ../../build/transformer -I../../../llvm/lib/clang/8.0.1/include/ -target:CUDA -DPUHTI_TRANSFORMER -DCUDA $1
    ../../build/transformer -I../../../llvm/lib/clang/8.0.1/include/ -target:CUDA -DPUHTI_TRANSFORMER -DCUDA $1 2>/dev/null
    check transform
}
