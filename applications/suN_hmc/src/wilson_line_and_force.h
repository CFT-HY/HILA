...
template <typename group,int L,typename atype=hila::arithmetic_type<group>>
void get_wloop_force_add(const GaugeField<group>& U,const Direction(&path)[L],atype eps,VectorField<Algebra<group>>& K) {
...
template <typename group,int L,typename atype=hila::arithmetic_type<group>>
void get_wloop_force(const GaugeField<group>& U,const Direction(&path)[L],atype eps,VectorField<Algebra<group>>& K) {
