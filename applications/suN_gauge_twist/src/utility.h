...
void print_formatted_numbers(const std::vector<Complex<T>> &numbers, std::string label,
    ...
    if (indices) {
        ...
        hila::out0 << label << ": ";
        for (int i = 0; i < numbers.size() - 1; i++) {
            hila::out0 << std::setprecision(12) << numbers[i].re << " " << numbers[i].im << ", ";
        }
        hila::out0 << std::setprecision(12) << numbers[numbers.size() - 1].re << " "
                   << numbers[numbers.size() - 1].im << "\n";
    }
}

template <typename T>
void print_formatted_numbers(const std::vector<T> &numbers, std::string label, bool indices,
                             bool sum = false) {
    ...
    if (indices) {
        ...
        hila::out0 << label << ": ";
        for (int i = 0; i < numbers.size() - 1; i++) {
            hila::out0 << std::setprecision(12) << numbers[i] << ", ";
        }
        hila::out0 << std::setprecision(12) << numbers[numbers.size() - 1] << "\n";
    }
}
