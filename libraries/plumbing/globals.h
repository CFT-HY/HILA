 ...
 * Variable cannot be initialized in declaration (value is 0)
 *
 * Variable assingment:
 *   > globalvar = <value>;
 ...
 *
 * The value of the variable is obtained with "()"
 *   > globalvar()
 ...
 *
 *          ...
 *          // inside other function - use helper struct to assign values
 *          param_t tmp;
 *          tmp.a = 3*M_PI;  
 *          tmp.b[0] = ....
 *          tmp.b[1] = ...
 ...
 * 
 *          globals::a = 3;
 *          hila::out0 << "a has value " << globals::a() << '\n';
 * 
 */
