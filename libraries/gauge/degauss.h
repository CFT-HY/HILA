...
void gauss_fix_step(const GaugeField<group> &U, VectorField<Algebra<group>> &E,
                    ...
                    const hila::arithmetic_type<group> mag) {
...
auto degauss_step(const GaugeField<group> &U, VectorField<Algebra<group>> &E) {
    ...
    constexpr hila::arithmetic_type<group> onealeph = aleph / 12.0;
    constexpr hila::arithmetic_type<group> twoaleph = 2.0 * onealeph;
