...
ifndef DEBUG
	CXXFLAGS := -O3 -x c++ --std=$(CPPSTD) -march=native -mavx2 -mfma -fabi-version=0 -fomit-frame-pointer
else
	CXXFLAGS := -g -x c++ --std=$(CPPSTD) -march=native -mavx2 -mfma -fabi-version=0 -fomit-frame-pointer
endif
CXXFLAGS_NOOPT := -x c++ --std=$(CPPSTD) -march=native -O1
