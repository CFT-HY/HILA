...
# Define compiler
CC = nvcc
LD = nvcc -gencode arch=compute_90,code=sm_90 --use_fast_math --restrict

# Define compilation flags  -  80 for Ampere
CXXFLAGS = -dc -O3 -std=c++17 -x cu -gencode arch=compute_90,code=sm_90 --use_fast_math --restrict 
