...
TEST_CASE_METHOD(TestCoordinateVector, "CoordinateVector constructor",
                 "[CoordinateVector]") {
...
TEST_CASE_METHOD(TestCoordinateVector, "CoordinateVector assignment",
                 "[coordinateVector]") {
...
TEST_CASE_METHOD(TestCoordinateVector, "CoordinateVector indexing",
                 "[CoordinateVector]") {
...
TEST_CASE_METHOD(TestCoordinateVector, "CoordinateVector translation",
                 "[CoordinateVector]") {
...
TEST_CASE_METHOD(TestCoordinateVector, "CoordinateVector mathematical methods",
                 "[CoordinateVector]") {
